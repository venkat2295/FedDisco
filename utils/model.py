...
class SimpleCNN(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.relu(self.fc1(x))
        feature = self.relu(self.fc2(x))  # This will be our feature representation
        out = self.fc3(feature)
        
        # Return three values to match the expected interface:
        # feature, feature, output (similar to ModelFedCon_noheader)
